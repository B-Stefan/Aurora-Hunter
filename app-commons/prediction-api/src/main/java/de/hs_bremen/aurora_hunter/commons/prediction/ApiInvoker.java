...
import de.hs_bremen.aurora_hunter.commons.prediction.auth.Authentication;
import de.hs_bremen.aurora_hunter.commons.prediction.auth.ApiKeyAuth;
import de.hs_bremen.aurora_hunter.commons.prediction.auth.HttpBasicAuth;
import de.hs_bremen.aurora_hunter.commons.prediction.request.GetRequest;
import de.hs_bremen.aurora_hunter.commons.prediction.request.PostRequest;
import de.hs_bremen.aurora_hunter.commons.prediction.request.PutRequest;
import de.hs_bremen.aurora_hunter.commons.prediction.request.DeleteRequest;
import de.hs_bremen.aurora_hunter.commons.prediction.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public String invokeAPI(String host, String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, String> formParams, String contentType, String[] authNames) throws ApiException, InterruptedException, ExecutionException, TimeoutException {
     ...
     if(request != null) {
         request.setRetryPolicy(new DefaultRetryPolicy(connectionTimeout,2,1));
